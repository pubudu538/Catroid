...
public class SetFrictionBrickTest extends BaseActivityInstrumentationTestCase<ScriptActivity> {

	private static final int SET_FRICTION = 42;
	...
	public void testSetFrictionBrick() {
		...
		UiTestUtils.testBrickWithFormulaEditor(solo, R.id.brick_set_friction_edit_text, SET_FRICTION, "friction",
				setFrictionBrick);
	}
	...
	private void createProject() {
		...
		setFrictionBrick = new SetFrictionBrick(sprite, 0);
