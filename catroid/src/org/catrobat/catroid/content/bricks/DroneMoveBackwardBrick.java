...
public class DroneMoveBackwardBrick extends BrickBaseType implements OnItemSelectedListener {
	private static final long serialVersionUID = 1L;

	private transient AdapterView<?> adapterView;

	public DroneMoveBackwardBrick(Sprite sprite) {
		this.sprite = sprite;
	...
	@Override
	public Brick clone() {
		return new DroneMoveBackwardBrick(getSprite());
	}
	...
	public View getViewWithAlpha(int alphaValue) {
		...
		if (view != null) {
			...
			View layout = view.findViewById(R.id.brick_drone_move_backward);
