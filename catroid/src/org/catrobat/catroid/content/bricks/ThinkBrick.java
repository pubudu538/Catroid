...
public class ThinkBrick extends BubbleBrickBaseType {
	...
	public ThinkBrick(Sprite sprite, String say, Context context) {
		super(sprite, say, SECONDS, context);
	}

	public ThinkBrick(Sprite sprite, Formula say, Context context) {
		super(sprite, say, new Formula(SECONDS), context);
	}

	@Override
	public Brick copyBrickForSprite(Sprite sprite, Script script) {
		ThinkBrick copyBrick = (ThinkBrick) clone();
	...
	@Override
	public Brick clone() {
		return new ThinkBrick(getSprite(), text.clone(), context);
	}
